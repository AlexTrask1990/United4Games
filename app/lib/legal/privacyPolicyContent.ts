  ...
  sections: [
    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          blocks: [
            { type: "paragraph", text: "We may collect technical information about your device and your use of the App, including:" },
            {
              type: "list",
              items: [
                "device manufacturer, brand, model, and device type",
                "operating system and operating system version",
                "device language, locale and time zone",
                "device identifiers, advertising identifiers (such as GAID/AAID or IDFA, where available), app or installation identifiers, session identifiers, and other SDK-generated identifiers",
                "application version and related application information",
                "IP address, user-agent, network type, mobile carrier, and other network and connection information",
                "screen characteristics and device settings relevant to the operation of the App",
                "crash reports, error logs, diagnostic information, and SDK diagnostics",
                "performance information, including network latency, request and response timing, and other technical performance metrics",
                "other technical information necessary to operate, maintain, secure, analyze, and improve the App",
              ],
            },
          ],
        },
        {
          ...
          blocks: [
            { type: "paragraph", text: "When advertisements are displayed in the App, we and our Third-Party Services may collect or process information relating to advertising and your interactions with advertisements, including:" },
            {
              type: "list",
              items: [
                "advertising requests, impressions, views, clicks, rewarded advertising events, video interactions, and other advertising events",
                "information about ad placements, ad formats, campaigns, creatives, and advertising partners",
                "advertising auction, mediation, measurement, and attribution information",
                "advertising revenue and performance information",
                "device, technical, and approximate location information used in connection with advertising",
                "privacy choices, consent preferences, and related privacy signals communicated to advertising partners",
              ],
            },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "paragraph", text: "To support advertising within the App, we and our advertising partners may process certain information, including device and advertising identifiers, IP address, approximate location, device and network information, information about your interactions with advertisements, advertising and mediation information, and privacy or consent signals." },
        { type: "paragraph", text: "Such information may be transmitted to or processed by advertising networks, mediation platforms, advertising exchanges, demand-side platforms (DSPs), supply-side platforms (SSPs), measurement and attribution providers, fraud prevention providers, and other participants involved in the delivery and measurement of advertisements." },
